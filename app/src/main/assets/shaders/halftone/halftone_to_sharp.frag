...
void main() {
    ...
    float layersKept = (1.0 - uDimLevel * t) * (1.0 - protection);
    clockPhotoWeight = (1.0 - t) * layersKept + protection;
    clockToneWeight = t * layersKept;
